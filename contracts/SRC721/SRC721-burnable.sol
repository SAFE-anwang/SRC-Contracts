...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/IERC721Receiver.sol
...
// File: @openzeppelin/contracts@4.9.6/utils/introspection/IERC165.sol
...
// File: @openzeppelin/contracts@4.9.6/utils/introspection/ERC165.sol
...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/IERC721.sol
...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/extensions/IERC721Enumerable.sol
...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/extensions/IERC721Metadata.sol
...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/ERC721.sol
...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/extensions/ERC721Burnable.sol
...
// File: @openzeppelin/contracts@4.9.6/token/ERC721/extensions/ERC721Enumerable.sol
...
// File: contracts/SRC721/SRC721Meta.sol


pragma solidity ^0.8.0;


abstract contract SRC721Meta is Ownable {
    string _orgName;
    bytes _logo;
    string _description;
    string _officialUrl;
    ...
    function getLogoPayAmount() public view returns (uint256) {
        (bool success, bytes memory data) = PROPERTY_ADDR.staticcall(abi.encodeWithSignature("getOfficialValue(string)", "logo_payamount"));
        require(success, "get logo_payamount failed");
        return abi.decode(data, (uint256));
    }

    function getLogoPayAddress() public view returns (address) {
        (bool success, bytes memory data) = PROPERTY_ADDR.staticcall(abi.encodeWithSignature("getOfficialValue(string)", "logo_payaddress"));
...
contract SRC721 is SRC721Meta, ERC721, ERC721Enumerable, ERC721Burnable {
    ...
    function setMaxSupply(uint256 maxSupply_) public onlyOwner {
        require(maxSupply_ >= totalSupply(), "New max supply must be >= current supply");
        _maxSupply = maxSupply_;
    ...
    function amountAllowToMint(address addr_) public view returns (uint256) {
        return _allowList[addr_];
    }

    function remainSupply() public view returns (uint256) {
        if (_maxSupply == 0) return type(uint256).max;
        return _maxSupply - totalSupply();
    }

    function canMint(address addr_) public view returns (bool) {
